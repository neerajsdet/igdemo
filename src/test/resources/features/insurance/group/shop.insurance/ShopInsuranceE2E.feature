@shop-ins
Feature: Verify shop insurance E2E flow
  ...
  Scenario: Shop Insurance E2E flow verification
    ...
    Then perform the "POST" api call and validate response code 201
    ...
    Then perform the "POST" api call and validate response code 201 and get the value of "ORDER_ID,MID,native_withdraw_details.txnToken" from response and save in global data with key "order_id,mid,txn_token"
