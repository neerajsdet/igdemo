@motor
Feature: Verify Motor Insurance Inspection api, endpoint:/protection/motor-proposal/api/v1/inspection
  ...
  Scenario: Validate the motor policy api
    ...
    Given set the request base url "motor_url" and endpoint "motor_inspection_endpoint"
    Given set the request headers, query params
      | h:X-PIBPL-USER-SSO-TOKEN | h:X-PIBPL-USER-WALLET-TOKEN          |
      | sso_token                | 1f4ef8d6-fddc-4a1c-af17-fc0e50659900 |
