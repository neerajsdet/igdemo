@motor
Feature: Verify Motor Insurance Policy api, endpoint:/protection/motor-proposal/api/v1/policies
  ...
  Scenario: Validate the motor policy api
    ...
    Given set the request base url "motor_url" and endpoint "motor_policies_endpoint"
