...
public class InsuranceSteps extends Base {
  ...
  @When("perform the {string} api call {int} times and validate response code {int}")
  public void performApiCallAndValidateResponseCode(String httpMethod, int retryCount,
  ...
  public void performApiCallAndValidateResponseCode(String httpMethod, int retryCount,
      int expectedResponseCode, String jsonPathKeys, String globalDataKeys) {
    Base.reqResUtilMap.get(threadId)
        .processRequestAndVerifyResponseCodeAndGetValues(httpMethod, retryCount,
            expectedResponseCode, jsonPathKeys, globalDataKeys);
  }
  ...
  public void generateSsoToken(String mobile, String password, String key) {
    Map<String, String> headers = Map.of(
        ...
        "Authorization",
        "Basic cGF5dG0tcGctY2xpZW50LXN0YWdpbmc6YTc0MjZiZTAtYTJkZC00N2NmLWExODEtYjM3YzgwMWYzNGM2");
    Map<String, String> formParams = Map.of(
        ...
        "password", password);
    Base.reqResUtilMap.get(threadId)
        .setBaseUrlAndEndpoint("account_url", "account_authorize_api_endpoint");
    ...
    Response response = Base.reqResUtilMap.get(threadId)
        .processRequestAndVerifyResponseCode("POST", 5,200);
    ...
    formParams = Map.of(
        ...
        "code", code);
    Base.reqResUtilMap.get(threadId)
        .setBaseUrlAndEndpoint("account_url", "account_token_api_endpoint");
    Base.reqResUtilMap.get(threadId).setHeadersData(new HashMap<>(headers));
    Base.reqResUtilMap.get(threadId).setFormsData(new HashMap<>(formParams));
    response = Base.reqResUtilMap.get(threadId).processRequestAndVerifyResponseCode("POST", 5,200);
    String accessToken = (String) Base.reqResUtilMap.get(threadId)
        .getValueFromResponse(response, "access_token");
